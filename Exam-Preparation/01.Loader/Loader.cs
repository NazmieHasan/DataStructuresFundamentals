namespace _01.Loader
{
    ...
    using.System.Entity.Infrastructure;
    using System.Linq;
    ...
    public class Loader : IBuffer
    {
        ...
        public List<IEntity> RetainAllFromTo(BaseEntityStatus lowerBound, 
            BaseEntityStatus upperBound)
        {
        ...
        public void UpdateAll(BaseEntityStatus oldStatus, 
            BaseEntityStatus newStatus)
        {
            for (int i = 0; i < this.EntitiesCount; i++)
            {
